...
CREATE PROCEDURE Code4(IN old_name VARCHAR(30))
BEGIN 
    UPDATE vendors
...
DELIMITER $$
CREATE FUNCTION Code5(vcode INT, vstate VARCHAR(3))
RETURNS VARCHAR(255)
DETERMINISTIC
BEGIN
